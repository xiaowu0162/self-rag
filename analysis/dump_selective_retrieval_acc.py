...
model = '/local2/diwu/selfrag_model_cache/20240105_selfrag_critic_alldata/'   # selfrag/selfrag_llama2_7b selfrag/self_rag_critic
model_short = 'selfrag-critic-0105ckpt'   # selfrag-7b selfrag-critic
...
with open(out_file, 'w') as out_f:
    for entry in tqdm(critic_task2data['retrieval']):
        ...
        print(score_dict["[Retrieval]"], score_dict["[No Retrieval]"])
